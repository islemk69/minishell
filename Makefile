...
#    Updated: 2023/05/08 22:57:15 by hel-ouar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

CC = gcc -g

SRCS = main.c init_env/init_env.c init_env/init_env_util.c exec/exec.c utils/builtins_util.c utils/error.c builtins/builtins.c \
