...
#    Updated: 2023/05/06 19:11:35 by hel-ouar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

CC = gcc -g

SRCS = main.c init_env/init_env.c init_env/init_env_2.c exec/exec.c utils/error.c builtins/builtins.c \
       ...
       builtins/exit.c builtins/echo.c exec/here_doc.c exec/pipe.c exec/simple_exec.c exec/exec_utils.c exec/exec_utils_2.c  exec/redir_exec.c\
       parsing/check_line.c parsing/dollar.c parsing/dollar_here_doc.c exec/open.c
